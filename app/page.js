...
export default function Home() {
  return (
    <>
      <header
        className={"flex max-sm:flex-wrap gap-[1rem] sm:gap-[3rem] my-[3rem] mx-auto w-[90%] max-w-[75rem]"}
      >
        <div className="w-[45rem] h-[25rem] sm:pt-[1.5rem]">
          <ImageSlideshow />
        </div>
        <div className="pt-[2rem]">
          <div className={"text-[#ddd6cb] text-[1.5rem] mb-4"}>
            <h1 className="text-[1.7rem] sm:text-[2rem] font-bold font-display tracking-[0.15rem] uppercase bg-gradient-to-r from-[#f9572a] to-[#ffc905] text-transparent bg-clip-text">
              NextLevel Food for NextLevel Foodies
            </h1>
            <p className="text-[20px] sm:text-[24px]">Taste & share food from all over the world.</p>
          </div>
      ...
      <main>
        <section
          className={
            "flex flex-col text-[#ddd6cb] text-[1.5rem] max-w-[50rem] w-[90%] my-[3rem] mx-auto text-center gap-3"
          }
        >
